...
const helpSteps = [
  {
    ...
    links: [
      ...
      ['Fonts & text', '/dashboard/fonts'],
      ['Share preview', '/dashboard/metadata'],
    ],
  },
  {
    ...
    links: [
      ['Spotlight', '/dashboard/home'],
      ['Releases', '/dashboard/music'],
      ['Videos', '/dashboard/videos'],
      ['Tour dates', '/dashboard/tour'],
      ['About & bio', '/dashboard/about'],
  ...
  },
  {
    ...
    body: 'Use Media library for local uploads, then paste returned paths into image, logo, favicon, font, and download fields. Export the final EPK JSON before handoff.',
    links: [
      ['Media library', '/dashboard/assets'],
  ...
  },
  {
    ...
    body: 'Use View site to check the public site, then publish once validation passes. Review mobile, desktop, links, metadata, uploaded media, and any date-specific VIP package URLs.',
    links: [
      ['View site', '/'],
      ['Share preview', '/dashboard/metadata'],
      ['Tour dates', '/dashboard/tour'],
